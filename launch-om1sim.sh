...
# Python venv with Isaac Sim
VENV=/home/ubuntu/env_isaacsim
source "$VENV/bin/activate"

export OMNI_KIT_ACCEPT_EULA=YES

# Locate bundled ROS2 Humble libs (path varies by Isaac Sim version)
ROS2_LIB=""
for c in \
    "$VENV/lib/python3.11/site-packages/isaacsim/exts/isaacsim.ros2.bridge/humble/lib" \
    "$VENV/lib/python3.12/site-packages/isaacsim/exts/isaacsim.ros2.core/humble/lib" \
    "$VENV/lib/python3.11/site-packages/isaacsim/exts/isaacsim.ros2.core/humble/lib" \
    "$VENV/lib/python3.12/site-packages/isaacsim/exts/isaacsim.ros2.bridge/humble/lib"; do
